...
import AdminUserContainer from '/imports/containers/admin/user.jsx';
// import EditUserComponent from './components/admin/users/edit-user.jsx';
import AddNewUserComponent from '/imports/components/admin/users/user-new.jsx';
//
...
function isUserLoggedIn(context, redirect, stop) {
  if(Meteor.userId()) {
    ...
    console.log('shoudl be going to login');
    redirect('/login');
  }
}
