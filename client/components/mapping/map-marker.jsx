            ...
            <div className="popover-content">
              ...
              {comments.map((comment, i) => {
                ...
                return comment && !comment.hideComment && comment.comment && comment.comment.length > 0 && comment.comment !== 'undefined' ? <div key={i} style={{boxShadow: '1px 1px 2px 0 '+ _a.color}} className="pin-artist-comment">
                        ...
                        </div> : <div key={i} style={{boxShadow: '1px 1px 2px 0 '+ _a.color}} className="pin-artist-comment"><a className="artist-comment-link" href={FlowRouter.path('artist-guide', {name:_a.cityName, artistName:_a.artistSlug})}><div className="pin-artist">{_a.artistName} Recommendation</div></a></div>;
              })}
